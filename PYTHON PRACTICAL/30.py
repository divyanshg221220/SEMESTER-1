# Write a Program to create a class called ‘Student’ with fields such as : Enrollment Number, USS Name, Branch Name, Student Name etc. Instantiate a class and make a call to user defined function to display the details of students. 
