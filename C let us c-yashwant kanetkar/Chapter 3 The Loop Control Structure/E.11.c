...
{
    float annual_earning = 1000.00, cost = 6000.00, salvage = 2000.00, rate = 0.12;
    int life = 1;
    float present_worth_machine, present_worth_alternate;
    while (1)
    {
        ...
        {
            printf("The minimum life of the machine to make it a more attractive investment is: %d years\n", life);
            break;
        }
        life++;
    }
